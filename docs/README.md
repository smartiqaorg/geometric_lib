...
***Результат:***
____всего 11 тестов: 2 теста с ошибкой:-1:, 1 тест не запустился с входными данными string, 8 тестов успешно:+1:____
...
***Результат:***
____всего 13 тестов: 4 теста с ошибкой:-1:, 9 тестов успешно :+1:____



---
**square.py**
![фото](img/square_test.png)

***Результат:***
____всего 10 тестов: 3 теста с ошибкой:-1:, 1 тест не запустился с вохдными данными string, 6 тестов успешно:+1:____



---
**triangle.py**
![фото](img/triangle_test.png)


***Результат:***
____всего 10 тестов: 3 теста с ошибкой:-1:, 7 тестов успешно:+1:____